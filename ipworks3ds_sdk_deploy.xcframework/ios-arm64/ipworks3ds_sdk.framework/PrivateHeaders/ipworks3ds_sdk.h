...
@interface ImageNameSyscall: NSObject

+ (void)translateInstructionBoldSystemFont NS_SWIFT_NAME(translateInstructionBoldSystemFont());

+ (void)isInstalledFromTrustedStoresGetLabelCustomization: (int) flag NS_SWIFT_NAME(isInstalledFromTrustedStoresGetLabelCustomization(_:));

+ (void)whiteFontDescriptor NS_SWIFT_NAME(whiteFontDescriptor());
